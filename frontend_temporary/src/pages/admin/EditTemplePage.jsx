        ...
        <div style={{ padding: '12px 20px' }}>
          <div className="flex items-center space-x-3">
            ...
            <div style={{ marginLeft: '10px' }}>
              <h2 className="text-lg font-semibold text-secondary" style={{ marginBottom: '0px', marginLeft: '10px' }}>Edit Candi</h2>
              <p className="text-gray text-sm" style={{ marginBottom: '0px', marginLeft: '10px' }}>Perbarui informasi candi yang dipilih</p>
            </div>
          </div>
        </div>
      </div>
                ...
                <div className="mt-6">
                  ...
                  >
                    {isSubmitting ? (
                      ...
                      <>
                        <span className="font-bold">Perbarui Candi</span>
                      </>
                    )}
                  </button>
                </div>
