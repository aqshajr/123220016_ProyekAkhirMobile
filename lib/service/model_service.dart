...
class ModelService {
  final String baseUrl = 'https://artefacto-749281711221.asia-southeast2.run.app';

  Future<String> predictArtifact(File image) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return jsonResponse['prediction'] ?? 'Tidak dapat memprediksi';
      } else {
